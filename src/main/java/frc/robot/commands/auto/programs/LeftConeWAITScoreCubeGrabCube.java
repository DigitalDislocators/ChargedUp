...
public class LeftConeWAITScoreCubeGrabCube extends SequentialCommandGroup {
    
    public LeftConeWAITScoreCubeGrabCube(SwerveSys swerveSys, LiftSys liftSys, ClawSys clawSys, IntakeSys intakeSys, LightsSys lightsSys) {
        super(
